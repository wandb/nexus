...
func newRetryClient(apiKey string, logger *analytics.NexusLogger) *retryablehttp.Client {
	tr := &authedTransport{
		key:     apiKey,
...
func newGraphqlClient(url, apiKey string, logger *analytics.NexusLogger) graphql.Client {
